...
* В Kotlin все исключения непроверяемые(в Java - проверяемые и непроверяемые), компилятор не заставляет упаковывать весь кодв try/catch - минус!
* */