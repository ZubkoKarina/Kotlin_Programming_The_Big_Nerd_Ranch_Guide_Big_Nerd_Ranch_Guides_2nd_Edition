...
*   .first() и .last() - функции безопасного обращения по индексу
*   getOrELse(индекс){"<значение_по_умолч_вместо_исключения_если_эл_по_индексту_не_сущ>"}
*   getOrNull(индекс) - возращяет null вместо исключения
*/